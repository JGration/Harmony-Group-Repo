...
/*				'google_fonts' => array(
				...
				'counter_font' => array(
					'title' => __('Counter Numbers (Bold)', 'thegem'),
					'options' => array(
				...
				'counter_thin_font' => array(
					'title' => __('Counter Numbers (Thin)', 'thegem'),
					'options' => array(
						'counter_thin_font_family' => array(
							'title' => __('Font Family', 'thegem'),
							'type' => 'font-select',
							'description' => __('Select font family you would like to use. On the top of the fonts list you\'ll find web safe fonts', 'thegem'),
						),
						'counter_thin_font_style' => array(
							'title' => __('Font Style', 'thegem'),
							'type' => 'font-style',
							'description' => __('Select font style for your font', 'thegem'),
						),
						'counter_thin_font_sets' => array(
							'title' => __('Font Sets', 'thegem'),
							'type' => 'font-sets',
							'description' => __('Type in or load additional font sets which you would like to use with your chosen google font (latin-ext is loaded by default)', 'thegem'),
							'default' => 'latin,latin-ext'
						),
						'counter_thin_font_size' => array(
							'title' => __('Font Size', 'thegem'),
							'description' => __('Select the font size', 'thegem'),
							'type' => 'fixed-number',
							'min' => 10,
						...
						'counter_thin_line_height' => array(
							'title' => __('Line Height', 'thegem'),
							'description' => __('Select the line height', 'thegem'),
							'type' => 'fixed-number',
							'min' => 10,
						...
						'counter_thin_custom_responsive_fonts' => array(
							'title' => __('Use manual settings for mobiles and tablets', 'thegem'),
							'type' => 'checkbox',
							'value' => 1,
							'default' => 0,
						),
						'counter_thin_custom_responsive_fonts_group' => array(
							'type' => 'hidden-group',
							'options' => array(
								'counter_font_size_tablet' => array(
									'title' => __('Font Size for Tablets', 'thegem'),
								...
								'counter_thin_line_height_tablet' => array(
									'title' => __('Line Height for Tablets', 'thegem'),
									'description' => __('Select the line height', 'thegem'),
									'type' => 'fixed-number',
									'min' => 10,
								...
								'counter_thin_font_size_mobile' => array(
									'title' => __('Font Size for Mobiles', 'thegem'),
									'description' => __('Select the font size', 'thegem'),
									'type' => 'fixed-number',
									'min' => 10,
								...
								'counter_thin_line_height_mobile' => array(
									'title' => __('Line Height for Mobiles', 'thegem'),
									'description' => __('Select the line height', 'thegem'),
									'type' => 'fixed-number',
									'min' => 10,
...
function thegem_color_skin_defaults($skin = 'light') {
	$skin_defaults = apply_filters('thegem_default_skins_options', array(
		'light' => array(
			...
			'counter_thin_font_family' => 'Montserrat UltraLight',
			'counter_thin_font_style' => 'regular',
			'counter_thin_font_sets' => '',
			'counter_thin_font_size' => '50',
			'counter_thin_line_height' => '69',
			'counter_thin_font_size_tablet' => '36',
			'counter_thin_line_height_tablet' => '53',
			'counter_thin_font_size_mobile' => '36',
			'counter_thin_line_height_mobile' => '53',
...
function thegem_version_update_options() {
	...
	if($theme_options['counter_thin_font_family'] == 'Montserrat UltraLight' && $theme_options['counter_thin_font_size'] == '16') {
		$theme_options['counter_thin_font_family'] = 'Montserrat UltraLight';
		$theme_options['counter_thin_font_style'] = 'regular';
		$theme_options['counter_thin_font_sets'] = '';
		$theme_options['counter_thin_font_size'] = '50';
		$theme_options['counter_thin_line_height'] = '69';
		$theme_options['counter_thin_font_size_tablet'] = '36';
		$theme_options['counter_thin_line_height_tablet'] = '53';
		$theme_options['counter_thin_font_size_mobile'] = '36';
		$theme_options['counter_thin_line_height_mobile'] = '53';
	}
...
function thegem_submit_activation() {
	...
	if(!empty($_REQUEST['purchase_code'])) {
		...
		update_option('thegem_theme_options', $theme_options);
		$response_p = wp_remote_get(add_query_arg(array('code' => $_REQUEST['purchase_code'], 'site_url' => get_site_url(), 'type' => 'elementor'), esc_url('http://democontent.codex-themes.com/av_validate_code.php')), array('timeout' => 20));
...
function thegem_check_activation($theme_options) {
	if(get_option('thegem_activation')) {
		if(empty($theme_options['purchase_code'])) {
			...
			$response_p = wp_remote_get(add_query_arg(array('code' => $theme_options['purchase_code'], 'site_url' => get_site_url(), 'type' => 'elementor'), esc_url('http://democontent.codex-themes.com/av_validate_code.php')), array('timeout' => 20));
			if(!is_wp_error($response_p)) {
				$rp_data = json_decode($response_p['body'], true);
				if(is_array($rp_data) && isset($rp_data['result']) && $rp_data['result'] && isset($rp_data['item_id']) && $rp_data['item_id'] === '16061685') {
					update_option('thegem_activation', 1);
