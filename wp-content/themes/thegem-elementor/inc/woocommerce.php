...
function thegem_woocommerce_scripts() {
	if(thegem_is_plugin_active('woocommerce/woocommerce.php')) {
		...
		wp_register_script('thegem-product-gallery', get_template_directory_uri() . '/js/thegem-product-gallery.js', array('jquery', 'jquery-carouFredSel'), '', true);
		wp_register_script('thegem-woocommerce', get_template_directory_uri() . '/js/thegem-woocommerce.js', array('jquery', 'thegem-product-gallery'), '', true);
